...
FloatingWindow {
    ...
    ListModel {
        ...
        ListElement{
            name: "rosewater"
            themeColor: function() { return ColorScheme.rosewater }
        }
        ListElement{
            name: "flamingo"
            themeColor: function() { return ColorScheme.flamingo }
        }
        ListElement{
            name: "pink"
            themeColor: function() { return ColorScheme.pink }
        }
        ListElement{
            name: "mauve"
            themeColor: function() { return ColorScheme.mauve }
        }
        ListElement{
            name: "red"
            themeColor: function() { return ColorScheme.red }
        }
        ListElement{
            name: "maroon"
            themeColor: function() { return ColorScheme.maroon }
        }
        ListElement{
            name: "yellow"
            themeColor: function() { return ColorScheme.yellow }
        }
        ListElement{
            name: "green"
            themeColor: function() { return ColorScheme.green }
        }
        ListElement{
            name: "teal"
            themeColor: function() { return ColorScheme.teal }
        }
        ListElement{
            name: "sky"
            themeColor: function() { return ColorScheme.sky }
        }
        ListElement{
            name: "sapphire"
            themeColor: function() { return ColorScheme.sapphire }
        }
        ListElement{
            name: "blue"
            themeColor: function() { return ColorScheme.blue }
        }
        ListElement {
            name: "lavender"
            themeColor: function() { return ColorScheme.lavender }
        }
    }
    ...
    property var changedSettings: {"bar": {}, "theming": {}, "appDefaults": {}, "catppuccinaccent": ""}
        ...
        ScrollView {
            ...
            WrapperRectangle {
                ...
                ColumnLayout {
                    ...
                    Text {
                        text: "this only takes effect in GTK apps after logging out and back in, because they use an environment variable for theming. Also, sometimes quickshell dosen't update the first time a accent is clicked. In case that happens, just click the theme you want again (or log out and back in)"
                        color: Theme.text
                        font.family: Theme.fontFamily
                    ...
                    GridView {
                        ...
                        delegate: WrapperMouseArea{
                            ...
                            onClicked: {
                                root.currentAccent = colorItem.name
                                if(root.startAccent != root.currentAccent){
                                    root.changedSettings["catppuccinaccent"] = root.currentAccent
                                }else{
                                    root.changedSettings["catppuccinaccent"] = ""
                                }
                                root.changedSettingsString = JSON.stringify(root.changedSettings)
                            }

                            WrapperRectangle {
                                color: root.currentAccent == colorItem.name ? Theme.brightSurface : (colorItem.isHovered ? Theme.surface : "transparent")
                                margin: 8
                                border.color: root.currentAccent == colorItem.name ? Theme.accent : "transparent"
                                border.width: 2
    ...
    Process {
        ...
        stdout: StdioCollector {
            onStreamFinished: {
                ...
                root.currentAccent = jsonObject["catppuccinaccent"]
            }
        }
        running: true
    }
