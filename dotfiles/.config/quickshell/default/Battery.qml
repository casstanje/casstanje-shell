...
Rectangle {
    ...
    gradient: Gradient {
        ...
        GradientStop { position: UPower.displayDevice.percentage; color: UPower.displayDevice.state == UPowerDeviceState.PendingDischarge || UPower.displayDevice.state == UPowerDeviceState.Discharging  ? "#80f38ba8" : "#80a6e3a1" }
